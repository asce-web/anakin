...
$('body').prepend('<div class="secondary-alert"><p><strong>Attention</strong>: The ASCE Shopping cart and login features of the website are currently experiencing technical difficulties.  Please contact customer service if you need immediate assistance at 1-800-548-2723 or <a href="mailto:customercare@asce.org">customercare@asce.org</a>.</p></div>');
