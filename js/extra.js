...
$('body').prepend('<div class="secondary-alert"><p><strong>Shipping Delays: Book shipments are delayed up to 2 weeks due to a network outage at our fulfillment center.</strong> While certain systems have been rendered temporarily inaccessible, our team is working around the clock to restore these systems. We want to assure you that we take our commitment to members and customers very seriously and the fulfillment of ASCE Products and Services are among our top priorities. <strong>E-book purchases are available for immediate download.</strong></p></div>');
