...
const Component = require('./Component.class.js')
...
class Homepage {
  ...
  compile() {
     ...
     * @param   {Component} arg.component component builder for each item in the list
     */
    ...
    ;(function () {
      ...
      container.append(new Component(container.querySelector('template').content, function (frag, data) {
 ...
 */
Homepage.COMPONENT = {
  xStat      : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-stat.tpl.html'      ), 'utf8')).querySelector('template').content,  require('../tpl/x-stat.tpl.js'      )),
  xPortal    : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-portal.tpl.html'    ), 'utf8')).querySelector('template').content,  require('../tpl/x-portal.tpl.js'    )),
  xPub       : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-pub.tpl.html'       ), 'utf8')).querySelector('template').content,  require('../tpl/x-pub.tpl.js'       )),
  xHomeAction: new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-homeaction.tpl.html'), 'utf8')).querySelector('template').content,  require('../tpl/x-homeaction.tpl.js')),
  xPromo     : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-promo.tpl.html'     ), 'utf8')).querySelector('template').content,  require('../tpl/x-promo.tpl.js'     )),
  xJob       : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-job.tpl.html'       ), 'utf8')).querySelector('template').content,  require('../tpl/x-job.tpl.js'       )),
  xArticle   : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-article.tpl.html'   ), 'utf8')).querySelector('template').content,  require('../tpl/x-article.tpl.js'   )),
  xMember    : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-member.tpl.html'    ), 'utf8')).querySelector('template').content,  require('../tpl/x-member.tpl.js'    )),
  xHero      : new Component(jsdom.JSDOM.fragment(fs.readFileSync(path.join(__dirname, '../tpl/x-hero.tpl.html'      ), 'utf8')).querySelector('template').content,  require('../tpl/x-hero.tpl.js'      )),
}
